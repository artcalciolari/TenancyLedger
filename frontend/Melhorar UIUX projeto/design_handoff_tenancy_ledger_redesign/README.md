...
- **Duas colunas** (auto-fit minmax 300px): **"Precisa de atenção"** (lista acionável:
  ...
  /contracts) e **"Atividade recente"** (derivada de notificações). *Estas listas são um
  acréscimo de UX; se não houver endpoint dedicado, derive de dados já disponíveis ou esconda.*
